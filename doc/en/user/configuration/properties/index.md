...
| GEOSERVER_LOG_LOCATION<br>[/configuration/logging](/configuration/logging.md)    | x               | x             | x            |
| GEOSERVER_PRINT_CONFIG_DIR<br>[Printing Installation](../../extensions/printing/install.md) | x               |               | x            |
| RELINQUISH_LOG4J_CONTROL<br>[/configuration/logging](/configuration/logging.md)  | x               | x             | x            |
| GT2_LOGGING_REDIRECTION<br>[/configuration/logging](/configuration/logging.md)   | x               | x             | x            |
