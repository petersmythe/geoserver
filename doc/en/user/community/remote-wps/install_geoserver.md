...
> [!WARNING]
> GeoServer won't connect to XMPP Server until it has been correctly configured and started as explained in the next section `extensions_wps_remote_install_xmpp`.
